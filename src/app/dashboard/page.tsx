...
export default function DashboardPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-background p-4 pb-24">
        ...
        {(supportLinks?.whatsappContactUrl || supportLinks?.whatsappGroupUrl || supportLinks?.telegramGroupUrl) && (
            <Card className="mb-4">
                <CardHeader className="p-3">
                    <CardTitle className="flex items-center text-base"><LifeBuoy className="mr-2 h-4 w-4"/>¿Necesitas Ayuda?</CardTitle>
                </CardHeader>
                <CardContent className="grid grid-cols-1 sm:grid-cols-3 gap-2 px-3 pb-3">
      ...
      <footer className="fixed bottom-0 left-0 right-0 bg-card border-t shadow-md z-50">
          <div className="grid grid-cols-6 items-center max-w-4xl mx-auto p-2">
            ...
            <Button variant={activeView === 'platforms' ? 'secondary' : 'ghost'} className="flex flex-col h-auto p-2" onClick={() => setActiveView('platforms')}>
                ...
                <span className="text-xs mt-1">Mis Plataformas</span>
            </Button>
