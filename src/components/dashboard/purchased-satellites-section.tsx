...
const PurchasedSatellitesSection = () => {
    ...
    if (!user) {
        return (
             <Card>
                <CardHeader>
                    <CardTitle>Mis Plataformas</CardTitle>
                </CardHeader>
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Mis Plataformas</CardTitle>
                <CardDescription>
                    Aquí puedes ver todas las plataformas de minería que has comprado y su progreso.
                </CardDescription>
            </CardHeader>
            <CardContent>
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {purchasedSatellites.length > 0 ? (
                        ...
                        <div className="col-span-full text-center text-muted-foreground py-16">
                            <h3 className="text-lg font-semibold">No tienes plataformas</h3>
                            <p>Ve a la sección "Comprar" para adquirir tu primera plataforma de minería.</p>
                        </div>
                    )}
                </div>
            </CardContent>
